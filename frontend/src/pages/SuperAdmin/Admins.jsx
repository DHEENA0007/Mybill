...
import { UserCheck, Plus, Edit, Search, Building2, Mail, Phone, Shield } from 'lucide-react';
    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500">Manage administrators for each company</p>
        </div>
        <button
          onClick={openCreate}
      ...
      {/* Create/Edit Modal */}
      <Modal open={formOpen} onClose={() => setFormOpen(false)} title={editItem ? 'Edit Admin' : 'New Company Admin'} size="md">
