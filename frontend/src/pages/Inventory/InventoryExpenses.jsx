...
import { getExpenses, createExpense, updateExpense, deleteExpense, getExpenseCategories, getExpenseSubcategories } from '../../api/inventoryExpenses';
...
export default function InventoryExpenses() {
  ...
  const { data: allExpensesData, isLoading } = useQuery({
    queryKey: ['inventory-expenses', activeFilters],
  ...
  const { data: formSubcategories } = useQuery({
    queryKey: ['inventory-expense-subcategories', formCategory],
  ...
  const { data: filterSubcategories } = useQuery({
    queryKey: ['inventory-expense-subcategories-filter', filters.category],
